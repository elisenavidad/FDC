...
require(["dojo/dom",
    ...
    gp = new esri.tasks.Geoprocessor("http://geoserver.byu.edu/arcgis/rest/services/hydropower_mskl/reservoirVolumeDR/GPServer/Reservoir%20Volume");
    ...
    function getResults(results) {
        var req2=esriRequest({
            "url": results.value.url,
            "handleAs": "text"
        });
        req2.then(requestSucceeded,requestFailed);
    }
